...
public class LTLayout: NSObject {
    ...
    /* 标题选中颜色，请使用RGB赋值 */
    @objc public var titleSelectColor: UIColor? = mainColor
    
    /* 标题字号 */
    @objc public var titleFont: UIFont? = UIFont(name: fontName, size: 16.0)
    
    /* 滑块底部线的颜色 - UIColor.blue */
    @objc public var bottomLineColor: UIColor? = mainColor
    
    /* 整个滑块的高，pageTitleView的高 */
    @objc public var sliderHeight: CGFloat = 44.0 * ratio
...
public class LTPageView: UIView {
    ...
    private lazy var scrollView: UIScrollView = {
		...
		scrollView.isScrollEnabled = false//layout.isScrollEnabled
